...
import SingleBlogPost from '../components/singleblogpots'
...
const Blog = props => {
  ...
  return (
    <Layout>
      <SingleBlogPost blogTitle={props.data.contentfulBlogPost.title} blogSubtitle={props.data.contentfulBlogPost.blogSubtitle} 
